...
PINMUX_CFG  PinMuxCfgTable[] = {
  ...
  { S0_DOMAIN,       IO_S0_UART0_TXD,        IO_FUNC01,   PU_ENABLE,  PD_DISABLE, ST_DEFAULT, DRV_STREN_DEFAULT }, // GPIO95
  { S0_DOMAIN,       IO_S0_UART0_RXD,        IO_FUNC01,   PU_ENABLE,  PD_DISABLE, ST_DEFAULT, DRV_STREN_DEFAULT }, // GPIO96
  { S0_DOMAIN,       IO_S0_UART1_TXD,        IO_FUNC00,   PU_ENABLE,  PD_DISABLE, ST_DEFAULT, DRV_STREN_DEFAULT }, // GPIO99
  { S0_DOMAIN,       IO_S0_UART1_RXD,        IO_FUNC00,   PU_ENABLE,  PD_DISABLE, ST_DEFAULT, DRV_STREN_DEFAULT }, // GPIO100
  // NON_GMAC1
